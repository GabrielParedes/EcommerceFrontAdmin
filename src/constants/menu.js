...
export const MENUITEMS = [
    ...
    },
    {
        title: 'Productos', icon: Box, type: 'sub', active: false, children: [
            ...
            //         // { path: '/products/physical/sub-category', title: 'Sub categorías', type: 'link' },
            //         // { path: '/products/physical/product-list', title: 'Lista de productos', type: 'link' },
            //         // { path: '/products/physical/product-detail', title: 'Detalle de producto', type: 'link' },
            //         { path: '/products/lista-de-productos', title: 'Product List', type: 'link' },
            //         { path: '/products/agregar-producto', title: 'Agregar producto', type: 'link' },
            //     ]
            // },
            // {
