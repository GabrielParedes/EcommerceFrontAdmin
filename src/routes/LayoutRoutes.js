		...
		<Fragment>
			<Routes>
				<Route element={<App />}>
					...
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/productos/categoria`}
						element={<Category />}
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/productos/lista-de-productos`}
						element={<Digitalprolist />}
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/productos/agregar-producto`}
						element={<Addproduct />}
					/>
